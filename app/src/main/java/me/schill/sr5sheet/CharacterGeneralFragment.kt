...
import me.schill.sr5sheet.databinding.FragmentCharacterGeneralBinding
import me.schill.sr5sheet.model.SR5Character
import me.schill.sr5sheet.persistence.Persistence

class CharacterGeneralFragment : EntityFragment<SR5Character, FragmentCharacterGeneralBinding>(SR5Character::class.java, R.layout.fragment_character_general) {
	...
	companion object {
		...
		fun newInstance(character: SR5Character) =
				CharacterGeneralFragment().apply {
